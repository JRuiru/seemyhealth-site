...
export const products: Record<string, Product> = {
  "ring-one": {
    ...
    specs: [
      ...
      { label: "Finishes", value: "Midnight Black, Aurora Gold" },
    ],
    features: [
      {
  ...
  "scale": {
    ...
    color: "#3B82F6",
    specs: [
      { label: "Sensors", value: "BIA (Bioelectrical Impedance Analysis)" },
      ...
      { label: "Platform", value: "Tempered glass, 300x300mm" },
    ...
    features: [
      ...
      {
        title: "Goal Setting",
        description: "Set target weight, body fat, or muscle mass goals. Get weekly progress summaries and adjustments in the app.",

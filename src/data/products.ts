...
export const products: Record<string, Product> = {
  ...
  "scale": {
    ...
    description: "Full body composition analysis with 4-point BIA. Step on and see weight, body fat, muscle mass, bone density, and 10 more metrics in the app instantly. Looking for segmental analysis? <a href='/products/scale-pro' class='underline hover:text-white transition-colors'>Check out The Scale Pro</a>.",
  ...
  "scale-pro": {
    ...
    crossSellImage: `${CF_IMG}/scale-pro-bathroom-still/public`,

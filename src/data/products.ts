...
export const products: Record<string, Product> = {
  ...
  "hema-one": {
    ...
    specs: [
      ...
      { label: "Volume", value: "~1μL per test" },
      { label: "Test Time", value: "5–15 seconds" },
      { label: "Markers", value: "Lipid Profile (TC, HDL-C, LDL-C, Triglycerides), Blood Glucose, Uric Acid, Hemoglobin" },
      ...
      { label: "Hematocrit Range", value: "25–55%" },
    ...
    features: [
      {
        title: "Quick Results",
        description: "Place a tiny sample on the test strip and insert into Hema One. Glucose and hemoglobin results in 5 seconds, full lipid profile in 15 seconds.",
        icon: "M13 2L3 14h9l-1 8 10-12h-9l1-8z",
      },
      {

...
export const products: Record<string, Product> = {
  ...
  "scale": {
    ...
    color: "#3B82F6",
    specs: [
      { label: "The Scale — Sensors", value: "BIA, 4-point electrode" },
      { label: "The Scale — Metrics", value: "13 body composition measurements" },
      { label: "The Scale — Battery", value: "4x AAA, up to 12 months" },
      { label: "The Scale — Display", value: "Hidden LED, auto-on" },
      { label: "Scale Pro — Sensors", value: "Dual-frequency BIA, 8-point electrode" },
      { label: "Scale Pro — Metrics", value: "21 body composition measurements" },
      { label: "Scale Pro — Segmental", value: "Arms, legs, trunk — individual readings" },
      { label: "Scale Pro — Display", value: "Full-color LED panel" },
      { label: "Max Weight", value: "180kg / 400lbs (Scale) · 200kg / 440lbs (Pro)" },
      { label: "Connectivity", value: "Bluetooth 5.0, Wi-Fi" },
      { label: "Users", value: "Unlimited profiles" },
      { label: "Colors", value: "Black, White (both variants)" },
    ],
    features: [
      {
      ...
      },
      {
        ...
        description: "Scale Pro only — see body fat and muscle mass for each arm, each leg, and your trunk separately. 8-point electrodes with retractable handle for clinical-grade precision.",
